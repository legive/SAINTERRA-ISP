...
Public Class rptVentasMensuales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAINTERRA.rptVentasMensuales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentasMensuales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentasMensuales = New rptVentasMensuales()
        rpt.Site = Me.Site
        Return rpt
    End Function

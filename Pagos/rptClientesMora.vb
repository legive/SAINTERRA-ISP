...
Public Class rptClientesMora
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SAINTERRA.rptClientesMora.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClientesMora
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClientesMora = New rptClientesMora()
        rpt.Site = Me.Site
        Return rpt
    End Function
